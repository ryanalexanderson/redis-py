...
redis-py has a Streams iterator object that provides access to interleaved
...
instance `r`. The example above tracks the three Redis streams `Stream0`, `Stream1`, and
`Stream2`, from epoch time_ms 0 (i.e. the entire message history).
